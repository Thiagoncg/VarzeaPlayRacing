// Description: CamFollowBehindEditor. Custom Editor
#if (UNITY_EDITOR)
using UnityEngine;
using UnityEditor;
using System;
...
{
    [CustomEditor(typeof(CamFollowBehind))]
    public class CamFollowBehindEditor : Editor
    {
        ...
        void OnEnable()
        {
            ...
            m_carSpeed = serializedObject.FindProperty("carSpeed");
            ...
            CamFollowBehind myScript = (CamFollowBehind)target;
