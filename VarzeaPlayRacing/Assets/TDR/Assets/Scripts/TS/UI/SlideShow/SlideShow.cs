...
namespace TS.Generics
{
    public class SlideShow : MonoBehaviour
    {
        ...
        public int                      currentCategory = -1;           // -1 : all category selected
        public int                      currentSelection = 0;
       // public int                      currentSelectionWhichCategory = 0;
        ...
        public CurrentText              txtSelectedEntry;
        public CurrentText              txtSelectedCategory;
        ...
        void DisplayTextSelectedEntry()
        {
            #region 
            if (txtSelectedEntry) txtSelectedEntry.DisplayTextComponent(txtSelectedEntry.gameObject, (currentSelection + 1) + "/" + howManyEntries); 
            #endregion
        }
        ...
        {
            #region 
            int howManyVehicleCategories = DataRef.instance.vehicleGlobalData.VehicleCategoryParamsList.Count;
            currentCategory++;
            if (currentCategory == howManyVehicleCategories) currentCategory = -1;
            ResetCategory(); 
            #endregion
        }
        ...
        public void PreviousCategory()
        {
            ...
            int howManyVehicleCategories = DataRef.instance.vehicleGlobalData.VehicleCategoryParamsList.Count;
            currentCategory--;
            if (currentCategory == -2) currentCategory = howManyVehicleCategories - 1;
            ResetCategory(); 
            #endregion
        }
        ...
        void ResetCategory()
        {
            ...
            GameModeTimeTrial.instance.currentSelection = 0;
            GameModeArcade.instance.currentSelection = 0;
            currentSelection = 0;
