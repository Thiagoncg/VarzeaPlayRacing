...
namespace TS.Generics
{
    public class ChampionshipResult : MonoBehaviour
    {
        ...
        public void ChampionshipResultPart2()
        {
            ...
            if (GameModeChampionship.instance.currentTrackInTheList < DataRef.instance.championshipModeData.listOfChampionship[currentChamp].listTrackParams.Count)
            {
        ...
        public void ChampDisplayGlobalPoints()
        {
            ...
            // Points for Player 1 and Player 2
            int howManyPlayer = 0;
            ...
            for (var i = 0; i < finalTrackPosList.Count; i++)
            {
                ...
                if (finalTrackPosList[i].ID < DataRef.instance.championshipModeData.pointsWinDependingFinalPosition.Count &&
                    (i + howManyPlayer) < DataRef.instance.championshipModeData.pointsWinDependingFinalPosition.Count)
                    trackPoints = DataRef.instance.championshipModeData.pointsWinDependingFinalPosition[i + howManyPlayer];
        ...
        IEnumerator DisplayScorePart2Routine()
        {
            ...
            yield return new WaitUntil(() => rewardAssistantEndChamp.bIsRewardDone == true);
            ...
            if (GameModeChampionship.instance.currentTrackInTheList == 0
                /*GameModeChampionship.instance.currentTrackInTheList < DataRef.instance.championshipModeData.listOfChampionship[currentChamp].listTrackParams.Count*/)
                btnList[2].SetActive(true);
            else
               btnList[3].SetActive(true);

            btnList[0].SetActive(true);
            ...
            else if (btnList[2].activeSelf)
            {
                ...
                btnList[4].SetActive(true);
                TS_EventSystem.instance.eventSystem.SetSelectedGameObject(btnList[4].transform.GetChild(1).gameObject);
            }
        ...
        int HowManyTrackInThisChampionship()
        {
            #region
            int currentChampionship = GameModeChampionship.instance.currentSelection;
            return DataRef.instance.championshipModeData.listOfChampionship[currentChampionship].listTrackParams.Count;
            #endregion
        }
    }
}
