    ...
    public class GaugeScale : MonoBehaviour
    {
        ...
        float ReturnParamValue(int vehicleID,float selectedParam)
        {
            ...
            switch (selectedParam)
            {
                ...
                case 8:
                    float speed = InfoVehicle.instance.vehicleParametersInGameList[vehicleID].Prefab.transform.GetChild(0).GetComponent<CarController>().maxSpeed;
                    return speed;
                case 9:
                    float acceleration = InfoVehicle.instance.vehicleParametersInGameList[vehicleID].Prefab.transform.GetChild(0).GetComponent<CarController>().forwardForceApplied;
                    return acceleration;
                case 10:
                    float brakeForce = InfoVehicle.instance.vehicleParametersInGameList[vehicleID].Prefab.transform.GetChild(0).GetComponent<CarController>().BrakeForce;
                    return brakeForce;
            }
            return 0; 
            #endregion
