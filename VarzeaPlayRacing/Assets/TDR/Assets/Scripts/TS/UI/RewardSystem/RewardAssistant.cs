// Description: RewardAssistant: Methods used during the reward process after a race.
    ...
    public class RewardAssistant : MonoBehaviour
    {
        ...
        IEnumerator UnlockNewChampRewardRoutine()
        {
            ...
            else
            {
                ...
                // Use to display medal in the championiship menu selection
                if (GameModeChampionship.instance.listChampionshipPosition[currentChampionship] > pos &&
                       pos == 0 || pos == 1 || pos == 2
                       ||
                       GameModeChampionship.instance.listChampionshipPosition[currentChampionship] == -1 &&
                       pos == 0 || pos == 1 || pos == 2
                       )
                    GameModeChampionship.instance.listChampionshipPosition[currentChampionship] = pos;
            }
