    ...
    public class CurrentTextEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (!bBypass.boolValue)
            {
                ...
                if (tab.intValue == 0 && FindFirstObjectByType<LanguageManager>())   // 0: Text is always the same
                {
                    ...
                    if (GUILayout.Button("Apply Text"))
                    {
                        ...
                        if (myScript.GetComponent<Text>())
                            serializedObject2 = new UnityEditor.SerializedObject(myScript.GetComponent<Text>());
                        else
                            serializedObject2 = new UnityEditor.SerializedObject(myScript.GetComponent<TextMeshProUGUI>());
