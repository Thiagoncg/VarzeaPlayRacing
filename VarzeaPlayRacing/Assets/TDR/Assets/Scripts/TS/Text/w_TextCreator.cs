...
namespace TS.Generics
{
    public class w_TextCreator : EditorWindow
    {
        ...
        void OnEnable()
        {
            ...
            string objectPath = "Assets/TDR/Assets/Datas/Ref/globalTextDatas.asset";
        ...
        void CreateNewTextDatas()
        {
            ...
            string newPath = "Assets/TDR/Assets/Datas/" + assetName + ".asset";
            ...
            if (GUILayout.Button("Create"))
            {
                ...
                if (!dataAlreadyExist)
                {
                    string objectPath = "Assets/TDR/Assets/Datas/Ref/TextDatasEmpty.asset";
                    AssetDatabase.CopyAsset(objectPath, newPath);
