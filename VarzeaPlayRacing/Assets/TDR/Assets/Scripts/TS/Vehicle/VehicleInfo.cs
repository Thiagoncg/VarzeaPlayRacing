// Description: VehicleInfo. ATtached to the vehicle. Access from any script various information.
...
namespace TS.Generics
{
    public class VehicleInfo : MonoBehaviour
    {
        ...
        IEnumerator InitVehicleInfoRoutine()
        {
            ...
            {
                //Debug.Log("Init: VehicleInfo -> Done" + transform.parent.GetComponent<VehiclePrefabInit>().playerNumber);
