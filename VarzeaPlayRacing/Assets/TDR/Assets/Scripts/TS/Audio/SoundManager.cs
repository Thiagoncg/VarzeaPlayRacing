    ...
    public class SoundManager : MonoBehaviour
    {
        ...
        public bool Bool_SaveMixerValues()
        {
            ...
            for (var i = 0; i < listAudioGroupParams.Count; i++)
            {
                ...
                listGroupVolume[i] = returnVolume(listAudioGroupParams[i].volume);
            }
        ...
        public IEnumerator LoadGroupVolume()
        {
            ...
            if (sParams != "")
            {
                ...
                for (var i = 0; i < codes.Length - 1; i++)
                {
                    ...
                    listGroupVolume.Add(returnVolume(volume));
            ...
            else
            {
                ...
                for (var i = 0; i < listAudioGroupParams.Count; i++)
                {
                    ...
                    listGroupVolume.Add(returnVolume(listAudioGroupParams[i].volume));
