...
namespace TS.Generics
{
    public class w_ChampionshipManager : EditorWindow
    {
        ...
        void OnEnable()
        {
            ...
            string objectPath = "Assets/TDR/Assets/Datas/Ref/GameMode/ChampionshipModeData.asset";
            ...
            //-> Access Track data
            objectPath = "Assets/TDR/Assets/Datas/Ref/TracksData.asset";
        ...
        void ShowChampionshipList()
        {
            ...
            for (var i = 0; i < listOfChampionship.arraySize; i++)
            {
                ...
                SerializedProperty m_whichVehicleCatogoryAllowed = listOfChampionship.GetArrayElementAtIndex(i).FindPropertyRelative("whichVehicleCatogoryAllowed");
                ...
                if (m_showInCustomEditor.boolValue)
                {
                    ...
                    EditorGUILayout.BeginHorizontal();
                    EditorGUILayout.LabelField("Vehicle Category: ", GUILayout.Width(120));
                    DisplayCategory(m_whichVehicleCatogoryAllowed);
                    EditorGUILayout.EndHorizontal();
        ...
        void AddNewChampionship()
        {
            ...
            if (GUILayout.Button("Create New Championship", GUILayout.Height(30)))
            {
                ...
                SerializedProperty m_whichVehicleCatogoryAllowed = listOfChampionship.GetArrayElementAtIndex(0).FindPropertyRelative("whichVehicleCatogoryAllowed");
                ...
                m_whichVehicleCatogoryAllowed.intValue = 0;
