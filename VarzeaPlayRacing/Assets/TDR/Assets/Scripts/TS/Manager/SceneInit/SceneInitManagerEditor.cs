//Description: SceneInitManagerEditor: Custom Editor
#if (UNITY_EDITOR)
using UnityEngine;
using UnityEditor;
...
{
    [CustomEditor(typeof(SceneInitManager))]
    public class SceneInitManagerEditor : Editor
    {
        ...
        private void displayAllTheMethods(GUIStyle style_Yellow_01, GUIStyle style_Blue)
        {
            #region
            //--> Display feedback
            SceneInitManager myScript = (SceneInitManager)target;
