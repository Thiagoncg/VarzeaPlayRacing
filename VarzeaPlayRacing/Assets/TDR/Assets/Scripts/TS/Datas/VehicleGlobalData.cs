...
namespace TS.Generics
{
    ...
    public class VehicleGlobalData : ScriptableObject
    {
        ...
        public class CarParameters
        {
            ...
            public float        offsetselectionCamP1RotationZInMenu = 0;
            ...
            public CarParameters(CarParameters carParams)
            {
                ...
                offsetselectionCamP1RotationZInMenu = carParams.offsetselectionCamP1RotationZInMenu;
        ...
        [System.Serializable]
        public class VehicleCategoryParams
        {
            public string   Name = "Category 0";
            public int      ListID = 0;
            public int      EntryID = 0;
            public Sprite   sprite;
        }
        public List<VehicleCategoryParams> VehicleCategoryParamsList = new List<VehicleCategoryParams>();
        ...
        public List<int>        gameModeThatWaitVehicleRefInitList = new List<int>();
    }
}
