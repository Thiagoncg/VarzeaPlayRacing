...
namespace TS.Generics
{
    ...
    {
        public bool showGizmoSceneViewToolbar = false;
        ...
        public bool diaplayBezierPath = true;
        public bool drawCurvePointsAndTangents = true;
       ...
       // [HideInInspector]
        ...
        public float        toolbarScaleHandle_Lenght = .5f;
        public float        toolbarRotation_Y = .2f;
        public float        toolbarRotation_Z = .2f;
        public float        toolbarTransform_X = .2f;
        public float        toolbarTransform_Y = .2f;
        public float        toolbarTransform_Z = .2f;

        public float        sliderMaxValue = 5;
